...
# 3 crossmaps for each of 7 years 2016 - 2022 from each of the three sections below,
# making 3 * 7 = 21 tables in total.
...
icd10_freq_prep <- function()
{
  ...
  # Parse ED files
  ca_icd10_freqs_ed_2022 <- 
    read_xlsx(
      path=here::here("etc/icd10_freq_tables/2022_diagnosiscodefrequencies_ed.xlsx"),
      sheet="Diagnosis Code Frequencies 2022") %>% 
    mutate(
  ...
  ca_icd10_freqs_ed_2021 <- 
    read_xlsx(
      path=here::here("etc/icd10_freq_tables/2021-hospital-emergency-department-diagnosis-code-frequency.xlsx"),
  ...
  ca_icd10_freqs_ed_2020 <- 
    read_xlsx(
      path=here::here("etc/icd10_freq_tables/2020-hospital-emergency-department-diagnosis-code-frequency.xlsx"),
  ...
  ca_icd10_freqs_ed_2019 <- 
    read_xlsx(
      path=here::here("etc/icd10_freq_tables/2019-hospital-emergency-department-diagnosis-code-frequency.xlsx"),
  ...
  ca_icd10_freqs_ed_2018 <- 
    read_xlsx(
      path=here::here("etc/icd10_freq_tables/2018-hospital-emergency-department-diagnosis-code-frequency.xlsx"),
  ...
  ca_icd10_freqs_ed_2017 <- 
    read_xlsx(
      path=here::here("etc/icd10_freq_tables/2017-hospital-emergency-department-diagnosis-code-frequency.xlsx"),
  ...
  ca_icd10_freqs_ed_2016 <- 
    read_xlsx(
      path=here::here("etc/icd10_freq_tables/2016-hospital-emergency-department-diagnosis-code-frequency.xlsx"),
  ...
  ca_icd10_freqs_ed <- ca_icd10_freqs_ed_2016 %>% 
    ...
    union_all(ca_icd10_freqs_ed_2022) %>% 
    mutate(type = "ed_freq")
  ...
  rm(ca_icd10_freqs_ed_2022)
  
  # Parse IP files
  ca_icd10_freqs_ip_2022 <- 
    read_xlsx(
      path=here::here("etc/icd10_freq_tables/2022_diagnosiscodefrequencies_pdd.xlsx"),
      sheet="ICD-10-CM") %>% 
    mutate(
      ICD10CM = str_remove(ICDCMCode, "[:punct:]"),
      ICD10CDX = str_sub(ICD10CM, 1, 3),
  ...
  ca_icd10_freqs_ip_2021 <- 
    read_xlsx(
      path=here::here("etc/icd10_freq_tables/2021-hospital-inpatient-diagnosis-code-frequency.xlsx"),
      sheet="ICD-10-CM") %>% 
    mutate(
      ICD10CM = str_remove(ICDCMCode, "[:punct:]"),
      ICD10CDX = str_sub(ICD10CM, 1, 3),
  ...
  ca_icd10_freqs_ip_2020 <- 
    read_xlsx(
      path=here::here("etc/icd10_freq_tables/2020-hospital-inpatient-diagnosis-code-frequency.xlsx"),
      sheet="ICD-10-CM") %>% 
    mutate(
      ICD10CM = str_remove(ICDCMCode, "[:punct:]"),
      ICD10CDX = str_sub(ICD10CM, 1, 3),
  ...
  ca_icd10_freqs_ip_2019 <- 
    read_xlsx(
      path=here::here("etc/icd10_freq_tables/2019-hospital-inpatient-diagnosis-code-frequency.xlsx"),
      sheet="ICD-10-CM") %>% 
    select(-PrimaryDiag, -SecondDiag) %>%
    mutate(
      ICD10CM = str_remove(ICDCMCode, "[:punct:]"),
  ...
  ca_icd10_freqs_ip_2018 <- 
    read_xlsx(
      path=here::here("etc/icd10_freq_tables/2018-hospital-inpatient-diagnosis-code-frequency.xlsx"),
      sheet="ICD-10-CM") %>% 
    select(-PrimaryDiag, -SecondDiag)%>%
    rename(ICDCMCode=ICD10CMCODE) %>% 
    mutate(
  ...
  ca_icd10_freqs_ip_2017 <- 
    read_xlsx(
      path=here::here("etc/icd10_freq_tables/2017-hospital-inpatient-diagnosis-code-frequency.xlsx"),
      sheet="ICD-10-CM") %>% 
    select(-PrimaryDiag, -SecondDiag) %>%
    mutate(
      ICD10CM = str_remove(ICDCMCode, "[:punct:]"),
  ...
  ca_icd10_freqs_ip_2016 <- 
    read_xlsx(
      path=here::here("etc/icd10_freq_tables/2016-hospital-inpatient-diagnosis-code-frequency.xlsx"),
      sheet="ICD-10-CM") %>% 
  ...
  ca_icd10_freqs_ip <- ca_icd10_freqs_ip_2017 %>% 
    ...
    union_all(ca_icd10_freqs_ip_2022)
  
  # Build a DX description crosswalk based on the 6 files that DO have it...
  ...
  rm(ca_icd10_freqs_ip_2022)
  rm(dx_desc)
  
  # Parse OP files
  ca_icd10_freqs_op_2022 <- 
    read_xlsx(
      path=here::here("etc/icd10_freq_tables/2022_diagnosiscodefrequencies_as.xlsx"),
      sheet="Diagnosis Code 2022") %>% 
    mutate(
      ICD10CM = str_remove(ICDCMCode, "[:punct:]"),
      ICD10CDX = str_sub(ICD10CM, 1, 3),
      meps_year = 2022)
  ...
  ca_icd10_freqs_op_2021 <- 
    read_xlsx(
      path=here::here("etc/icd10_freq_tables/2021-ambulatory-surgery-diagnosis-code-frequency.xlsx"),
  ...
  ca_icd10_freqs_op_2020 <- 
    read_xlsx(
      path=here::here("etc/icd10_freq_tables/2020-ambulatory-surgery-diagnosis-code-frequency.xlsx"),
  ...
  ca_icd10_freqs_op_2019 <- 
    read_xlsx(
      path=here::here("etc/icd10_freq_tables/2019-ambulatory-surgery-diagnosis-code-frequency.xlsx"),
  ...
  ca_icd10_freqs_op_2018 <- 
    read_xlsx(
      path=here::here("etc/icd10_freq_tables/2018-ambulatory-surgery-diagnosis-code-frequency.xlsx"),
      sheet="Dx Code Frequencies 2018") %>% 
    select(-PrimaryDiag, -SecondDiag) %>%
    rename(ICDCMCode=ICD10CMCode) %>%
    mutate(
  ...
  ca_icd10_freqs_op_2017 <- 
    read_xlsx(
      path=here::here("etc/icd10_freq_tables/2017-ambulatory-surgery-diagnosis-code-frequency.xlsx"),
      sheet="Dx Code Frequencies 2017") %>% 
    select(-PrimaryDiag, -SecondDiag) %>%
    rename(ICDCMCode=ICD10CMCode) %>%
    mutate(
  ...
  ca_icd10_freqs_op_2016 <- 
    read_xlsx(
      path=here::here("etc/icd10_freq_tables/2016-ambulatory-surgery-diagnosis-code-frequency.xlsx"),
      sheet="Dx Code Frequencies 2016") %>% 
    select(ICDCMCode=ICD10CMCode, TotalDiag) %>%
    mutate(
      ICD10CM = str_remove(ICDCMCode, "[:punct:]"),
  ...
  ca_icd10_freqs_op <- ca_icd10_freqs_op_2017 %>% 
    ...
    union_all(ca_icd10_freqs_op_2022)
  ...
  ca_icd10_freqs <- ca_icd10_freqs_ed %>% 
    ...
    write_csv(here::here("etc/icd10_freq_tables/icd10_freqs.csv"))
