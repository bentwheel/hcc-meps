...
date: 29 September 2024 (preliminary release version)
...
source(here::here("src/cost_pred.R"))
...
Sure, [here's a zipfile](https://cslester.com/hcc-on-meps.zip) of all the output generated from this repo, along with some very light documentation. Enjoy!
